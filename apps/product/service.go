...
func (s service) CreateProduct(ctx context.Context, req CreateProductRequestPayload) (err error) {
	productEntity := NewFromCreateProductRequest(req)
...
func (s service) ListProducts(ctx context.Context, req ListProductsRequestPayload) (products []Product, err error) {
