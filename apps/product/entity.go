...
func NewProductPaginationFromProductRequest(req ListProductsRequestPayload) ProductPagination {
...
func NewFromCreateProductRequest(req CreateProductRequestPayload) Product {
	return Product{
		SKU:       uuid.NewString(),
		Name:      req.Name,
		Stock:     req.Stock,
