...
const (
	...
	TransactionStatus_Complete   TransactionStatus = 20
...
var (
	MappingTransactionStatus = map[TransactionStatus]string{
		...
		TransactionStatus_Complete:   TRX_COMPLETED,
	}
)
...
func NewTransactionFromRequest(req CreateTransactionRequestPayload) Transaction {
	return Transaction{
...
// set product id, price and productJSON
